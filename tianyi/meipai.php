...
<?php @$meipai = intval(file_get_contents("../api/tongji/jiekou/meipai.dat")); ?>
<?php @$meipaix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/meipai.dat")); ?>
...
<title>美拍短视频 - <?php echo $ming; ?>API</title>
...
<legend>美拍短视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $meipai; ?>次·今日调用：<?php echo $meipaix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meipai.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meipai.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(热门/直播/搞笑/爱豆/高颜值/舞蹈/音乐/美食/美妆/萌宠/旅行/吃秀/穿秀/运动/手工/游戏)(默认为热门)</td></tr>
<tr><td>type</td><td>否</td><td>输出方式(text/xml/json/js/jsx)(默认为text)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/meipai.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">美拍短视频
<?php echo $ming; ?>API美拍短视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meipai.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/meipai.php\n
━━━━━━━━━\n
