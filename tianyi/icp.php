...
<?php @$icp = intval(file_get_contents("../api/tongji/jiekou/icp.dat")); ?>
<?php @$icpx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/icp.dat")); ?>
...
<title>ICP备案查询 - <?php echo $ming; ?>API</title>
...
<legend>ICP备案查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $icp; ?>次·今日调用：<?php echo $icpx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/icp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/icp.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/icp.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/icp.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>String</td><td>是</td><td>需要查询的链接</td></tr>
...
<tr><td>Organizer</td><td>String</td><td>主办单位名称</td></tr>
<tr><td>SiteLicense</td><td>String</td><td>网站备案/许可证号</td></tr>
<tr><td>SiteName</td><td>String</td><td>网站名称</td></tr>
<tr><td>Index</td><td>String</td><td>网站首页网址</td></tr>
<tr><td>VerifyTime</td><td>String</td><td>审核时间</td></tr>
<tr><td>UpdateTime</td><td>String</td><td>数据更新时间</td></tr>
</tbody>
</table>
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/icp.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<tr><td>-1</td><td>域名错误</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
<p class="linep">机器人词库示例：</p>
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">ICP备案查询
<?php echo $ming; ?>API♧ICP备案查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
ICP备案查询 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/icp.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

ICP备案查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/icp.php?url=%参数1%&type=text$</per>
</div>
</div>
</div>
</div>
