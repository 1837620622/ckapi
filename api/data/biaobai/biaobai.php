...
<head>
<meta charset="utf-8"/>
<title>我喜欢你❤<?php echo $_GET['a'] ?>️</title>
<!-- style -->
	...
	<div id="div_onlyyou">
		...
		<div id="div_oy_inner">
			...
			<div class="div_oy_text">
				<h1></h1>
				<img class="img_oy_text" src="<?php echo $_GET['img'] ?>">
				<p class="p_oy_text"></p>
				<ul id="ul_oy_benefit">
...
var theme_content = {
	"pure_words_content": "<?php echo $_GET['a'] ?>，遇见你是我所有美好故事的开始，所以，请别放开我的手，也别缺席我的将来，因为一辈子和你在一起才叫将来<um style='color: #F44336;'>💕</um>",
	"typed_bool": "typed_y",
...
var main_title = '我喜欢你❤<?php echo $_GET['a'] ?>️';
...
var start_content = {
	chase_title: "<?php echo $_GET['a'] ?>，做我女朋友好不好<um style='color: #F44336;'>💕</um>",
