...
<body>
	...
	<div class="banner-video">
		...
		<video autoplay loop muted>
			<source src="<?= empty($this->site->background) ? 'https://cdn.jsdelivr.net/gh/5iux/uploads/pic/3840-banner.mp4' : $this->site->background ?>" type="video/mp4">
		</video>
		<!--注释掉视频可换成图片版本-->
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="position: absolute; z-index: 10000;">
		...
		<div class="collapse navbar-collapse" id="navbarsExample05">
			<ul class="navbar-nav mr-auto">
				<?php
				(function () {
					if (empty($this->options->CustomNavs)) {
						return;
					}
					$custom = [];
	...
	<div class="container" style="margin-top: 100px; position: relative; z-index: 100;">
			...
			<div id="search-list" class="hide-type-list">
				<div class="search-group group-a s-current" style="padding-left: 20px">
					<ul class="search-type">
						...
						<li><input hidden="" type="radio" name="type" id="type-cupfox" value="https://soupian.one/search?key=" data-placeholder="电影、剧集、综艺、动漫"><label for="type-cupfox"><span style="color:#b1870b">影视</span></label></li>
		...
		if (!$this->auth()) echo '';
		(function () {
		...
		?>
			<ul class="mylist row">
				...
				?>
					<li class="col-3 col-sm-3 col-md-3 col-lg-1">
						<a rel="nofollow" href="<?= $value->url ?>" target="_blank">
							<img alt="" rel="<?= $value->rel ?>" src="<?= isset($value->favicon) ? $value->favicon : null ?>">
							<span><?= $value->title ?></span>
						</a>
					</li>
				<?php
	...
	<!--版权信息开始-->
	<p class="mt-5 mb-3 text-muted text-center">©2023 by <a href="http://<?= $this->site->domain ?>"><?= $title ?></a><?php if (!$this->auth()) echo base64_decode('LiBBbGwgcmlnaHRzIHJlc2VydmVkLueUsSA8YSBocmVmPSJodHRwOi8vZ3VpZGUuYnJpNi5jbiIgdGFyZ2V0PSJfYmxhbmsiPuaYk+iIque9keWdgOW8leWvvOezu+e7nzwvYT4g5by65Yqb6amx5Yqo') ?></p>
	<!--版权信息结束-->
	<script>
